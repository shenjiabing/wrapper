 ...
 * Desc:
 */
public abstract class WrapperBindingStatusActivity<VM extends BaseViewModel<? extends ILoaderModel>, V extends ViewDataBinding> extends WrapperBindingActivity<VM, V> implements IStatus {
