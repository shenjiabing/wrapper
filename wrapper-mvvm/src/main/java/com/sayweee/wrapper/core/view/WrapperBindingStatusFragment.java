 ...
 * Desc:
 */
public abstract class WrapperBindingStatusFragment<VM extends BaseViewModel<? extends ILoaderModel>, V extends ViewDataBinding> extends WrapperBindingFragment<VM, V> implements IStatus {
