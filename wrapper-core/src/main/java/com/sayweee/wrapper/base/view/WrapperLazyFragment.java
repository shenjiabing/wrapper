...
public abstract class WrapperLazyFragment extends WrapperFragment {
    ...
    private boolean isParentInvisible() {
        ...
        if (parentFragment instanceof WrapperLazyFragment) {
            WrapperLazyFragment fragment = (WrapperLazyFragment) parentFragment;
    ...
    private void dispatchChildVisibleState(boolean visible) {
        ...
        if (fragments != null && !fragments.isEmpty()) {
            for (Fragment child : fragments) {
                if (child instanceof WrapperLazyFragment && !child.isHidden() && child.getUserVisibleHint()) {
                    ((WrapperLazyFragment) child).dispatchUserVisibleHint(visible);
                }
            }
        }
    }
