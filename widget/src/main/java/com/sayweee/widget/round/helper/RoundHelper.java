package com.sayweee.widget.round.helper;
...
public class RoundHelper {
    ...
    public void onClipDraw(Canvas canvas) {
        ...
        if (Build.VERSION.SDK_INT <= Build.VERSION_CODES.O_MR1) {
            ...
            mDiffPath.reset();
            mDiffPath.addRect(0, 0, (int) mLayer.width(), (int) mLayer.height(), Path.Direction.CW);
            mDiffPath.op(mClipPath, Path.Op.DIFFERENCE);
            canvas.drawPath(mDiffPath, mPaint);
        }
    }
