...
public class SelectableRoundedImageView extends androidx.appcompat.widget.AppCompatImageView {
    ...
    public SelectableRoundedImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        float radius = (float)a.getDimensionPixelSize(R.styleable.SelectableRoundedImageView_sriv_corner_radius, 0);
        if(radius > 0) {
            this.mLeftTopCornerRadius = radius;
            this.mRightTopCornerRadius = radius;
            this.mLeftBottomCornerRadius = radius;
            this.mRightBottomCornerRadius = radius;
        }else {
    ...
    private Drawable resolveResource() {
        ...
        if (src == null) {
            ...
            if (this.mResource != 0) {
                try {
                    d = src.getDrawable(this.mResource);
    ...
    static class SelectableRoundedCornerDrawable extends Drawable {
        ...
        public static Drawable fromDrawable(Drawable drawable, Resources r) {
            if (drawable != null) {
                ...
                Log.w("SelectableRounded", "Failed to create bitmap from drawable!");
            }
        ...
        public int getOpacity() {
            ...
            return this.mBitmap != null && !this.mBitmap.hasAlpha() && this.mBitmapPaint.getAlpha() >= 255 ? PixelFormat.OPAQUE : PixelFormat.TRANSLUCENT;
        }
